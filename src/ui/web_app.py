...
def create_app(platform):
        ...
        [
            ...
            html.Div(
                [
                    ...
                    html.P(
                        "Sophisticated Earnings Power Value Analysis & Intrinsic Value Calculator",
                        style={
                            "textAlign": "center",
                            "fontSize": "18px",
                            "color": "#7f8c8d",
                    ...
                    html.Div(
                        [
                            ...
                            html.Div(
                                [
                                    html.Label(
                                        "Stock Symbol:", style={"fontWeight": "bold"}
                                    ),
                                    dcc.Input(
                                        id="symbol-input",
                                        type="text",
                            ...
                            html.Div(
                                [
                                    html.Label(
                                        "Analysis Type:", style={"fontWeight": "bold"}
                                    ),
                                    dcc.RadioItems(
                                        id="analysis-type",
                                        options=[
    ...
    def analyze_stock(n_clicks, symbol, peers, analysis_type, years):
        ...
        try:
            ...
            if peers:
                peer_symbols = [
                    p.strip().upper() for p in peers.split(",") if p.strip()
                ]
            ...
            if analysis_type == "quick":
                ...
                results = platform.analyze_stock(
                    symbol=symbol, peer_symbols=peer_symbols, years=years
                )
    ...
    def batch_analyze(n_clicks, symbols_text):
        ...
        try:
            ...
            if not symbols:
                return html.Div(
                    "Please enter valid stock symbols", style={"color": "#e74c3c"}
                )
            ...
            return html.Div(
                f"Batch analysis error: {str(e)}", style={"color": "#e74c3c"}
            )
...
def create_quick_results_display(results):
                ...
                [
                    ...
                    html.H2(
                        ...
                        style={
                            "color": (
                                "#27ae60"
                                if results["margin_of_safety"]
                                and results["margin_of_safety"] > 0
                                else "#e74c3c"
                            ),
                            "margin": "0",
                        },
            ...
            html.Div(
                ...
                style={
                    "backgroundColor": (
                        "#d5f4e6"
                        if results["quality_score"] > 0.6
                        else "#fdeaa7" if results["quality_score"] > 0.4 else "#fadbd8"
                    ),
                    "padding": "20px",
                    "borderRadius": "8px",
                    "textAlign": "center",
    ...
    summary_info = html.Div(
        [
            html.H3(
                f"Analysis Summary - {results['symbol']}", style={"color": "#2c3e50"}
            ),
            html.P(f"Company: {results['company_name']}", style={"fontSize": "16px"}),
            html.P(
                f"Normalized Earnings: ${results['normalized_earnings']:,.0f}",
                style={"fontSize": "14px"},
            ),
            html.P(
                f"Cost of Capital: {results['cost_of_capital']:.2%}",
                style={"fontSize": "14px"},
            ),
        ],
        style={
    ...
    return html.Div(
        [
            html.H3(
                f"Quick EPV Analysis - {results['symbol']}", style={"color": "#2c3e50"}
            ),
            metrics_cards,
            summary_info,
            scenarios_chart,
        ...
        [
            ...
            html.Div(
                [
                    ...
                    html.P(
                        (
                            f"Target: ${results['target_price']:.2f}"
            ...
            html.Div(
                [
                    html.H4(
                        "Risk Score", style={"color": "#2c3e50", "marginBottom": "10px"}
                    ),
                    html.H2(
                ...
                style={
                    "backgroundColor": (
                        "#d5f4e6"
                        if results["risk_score"] < 0.4
                        else "#fdeaa7" if results["risk_score"] < 0.7 else "#fadbd8"
                    ),
                    "padding": "20px",
                    "borderRadius": "8px",
                    "textAlign": "center",
...
def create_batch_results_display(results):
    ...
    summary_cards = html.Div(
        [
            html.Div(
                [
                    html.H4(
                        "Analyzed", style={"color": "#2c3e50", "marginBottom": "10px"}
                    ),
                    html.H2(
                        str(results["successful_analyses"]),
                        style={"color": "#3498db", "margin": "0"},
                    ),
                ],
                style={
            ...
            html.Div(
                [
                    html.H4(
                        "Avg EPV", style={"color": "#2c3e50", "marginBottom": "10px"}
                    ),
                    html.H2(
                        f"${stats.get('avg_epv', 0):.2f}",
                        style={"color": "#27ae60", "margin": "0"},
                    ),
                ],
                style={
            ...
            html.Div(
                [
                    ...
                    html.H2(
                        str(stats.get("undervalued_count", 0)),
                        style={"color": "#27ae60", "margin": "0"},
                    ),
                ],
                style={
            ...
            html.Div(
                [
                    ...
                    html.H2(
                        str(stats.get("high_quality_count", 0)),
    ...
    return html.Div(
        [
            ...
            summary_cards,
            html.H4(
                "Detailed Results", style={"color": "#2c3e50", "marginBottom": "15px"}
            ),
            results_table,
        ]
    )
