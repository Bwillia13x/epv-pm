...
def demo_quick_analysis():
    ...
    try:
        ...
        if results['margin_of_safety'] is not None:
            ...
            print(f"  • Margin of safety: {results['margin_of_safety']:.1f}% ({status})")
...
def demo_quality_assessment():
    ...
    try:
        ...
        income_statements = [
            IncomeStatement("DEMO", "annual", 2023, net_income=1000000, revenue=10000000),
        ...
        balance_sheets = [
            BalanceSheet("DEMO", "annual", 2023, total_assets=5000000, total_equity=3000000,
                        current_assets=2000000, current_liabilities=1000000),
            BalanceSheet("DEMO", "annual", 2022, total_assets=4500000, total_equity=2700000,
                        current_assets=1800000, current_liabilities=900000),
            BalanceSheet("DEMO", "annual", 2021, total_assets=4000000, total_equity=2400000,
                        current_assets=1600000, current_liabilities=800000)
        ]
