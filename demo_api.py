    ...
    try:
        ...
        for symbol in request.symbols[:20]:
            ...
            recommendation = (
                ...
                else "HOLD" if analysis["margin_of_safety"] > 0 else "SELL"
            )
...
async def get_company_profile(symbol: str):
    ...
    try:
        return {
            ...
            "latest_financials": {
                "income_statement": {
                    "revenue": round(random.uniform(10000000, 100000000000), 0)
                },
                "balance_sheet": {
                    "total_assets": round(random.uniform(50000000, 500000000000), 0)
                },
                "cash_flow": {
                    "operating_cash_flow": round(
                        random.uniform(1000000, 50000000000), 0
                    )
                },
